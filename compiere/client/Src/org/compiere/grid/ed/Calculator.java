	...
	implements ActionListener, KeyListener
{
	...
	{
		this (frame, Msg.getMsg(Env.getCtx(), "Calculator"), DisplayTypeConstants.Number, null, null);
	}   //  Calculator
	...
	{
		this (frame, Msg.getMsg(Env.getCtx(), "Calculator"), DisplayTypeConstants.Number, null, number);
	}   //  Calculator
	...
	{
		//	Get Default
		int C_Currency_ID = Env.getCtx().getContextAsInt( m_WindowNo, "C_Currency_ID");
		if (C_Currency_ID == 0)
			C_Currency_ID = Env.getCtx().getContextAsInt( "$C_Currency_ID");
