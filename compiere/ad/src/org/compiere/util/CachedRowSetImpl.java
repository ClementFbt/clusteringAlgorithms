...
public class CachedRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
     ...
     * @serial
     */
    private org.compiere.util.RowSetMetaDataImpl RowSetMD;
    ...
    public CachedRowSetImpl(Hashtable<String,String> env) throws SQLException {
    ...
    private void checkTransactionalWriter() {
        if (rowSetWriter != null) {
            ...
            if (c != null) {
                ...
                for (Class<?> element : theInterfaces) {
                    if ((element.getName()).indexOf("TransactionalWriter") > 0) {
                        tXWriter = true;
    ...
    public void populate(ResultSet data) throws SQLException {
        ...
        // set up the metadata
        RowSetMD = new org.compiere.util.RowSetMetaDataImpl();
        ...
        md.setColumnCount(numCols);
       	for (int col=1; col <= numCols; col++) 
       	{
       		...
       		try
       		{
        		...
        		md.setColumnName(col, name);
        		colType = rsmd.getColumnType(col);
        		md.setColumnType(col, colType);
        	...
        	{
        		System.err.println("ColumnName=" + name + ", Type=" + colType);
        		e.printStackTrace();
        	}
        }
    ...
    public void acceptChanges() throws SyncProviderException {
        ...
        try {
            ...
            if ((tXWriter) && COMMIT_ON_ACCEPT_CHANGES) {
            ...
            if (success == true) {
                setOriginal();
            } else if (!(success) && !(COMMIT_ON_ACCEPT_CHANGES)) {
    ...
    public void restoreOriginal() throws SQLException {
        Row currentRow;
        for (Iterator<Row> i = rvh.iterator(); i.hasNext();) {
            currentRow = i.next();
    ...
    public Collection<?> toCollection() throws SQLException {
        ...
        TreeMap<Integer, Row> tMap = new TreeMap<Integer, Row>();
    ...
    public void setSyncProvider(String providerStr) throws SQLException {
        provider = SyncFactory.getInstance(providerStr);
    ...
    public ResultSet getOriginal() throws SQLException {
        ...
        for (Row row : rvh) {
            orig = new Row(colCount, row.getOrigRow());
            crs.rvh.add(orig);
        }
        return crs;
    }
   ...
   /**
     ...
     */
     public void populate(ResultSet data, int start) throws SQLException{
        ...
        if( pageSize == 0) {
           rvh = new Vector<Row>(getMaxRows());

        }
        else{
            rvh = new Vector<Row>(getPageSize());
        }
...
public void setAsciiStream(String parameterName, java.io.InputStream x, int length)
   ...
   public void setAsciiStream(int index, java.io.InputStream x, long length)
   throws SQLException{
    throw new SQLFeatureNotSupportedException("Feature not supported");
}
...
public void setAsciiStream(String parameterName, java.io.InputStream x)
  ...
  @Override
public void setAsciiStream(int index, java.io.InputStream x)
  throws SQLException{
throw new SQLFeatureNotSupportedException("Feature not supported");
}
