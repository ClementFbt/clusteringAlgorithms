...
public class Language implements Serializable
{
	...
	private static final String AD_Language_lt_LT = "lt_LT";
	...
	static private Language[]   s_languages = {
		...
		new Language ("\uFE94\uFEF4\uFE91\uFEAE\uFECC\uFEDF\uFE8D (AR)",
			AD_Language_ar_TN,  new Locale("ar","TN"), Boolean.valueOf(true), "dd.MM.yyyy",
			MediaSize.ISO.A4),
		new Language ("\u0411\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (BG)",
			AD_Language_bg_BG,  new Locale("bg","BG"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
		new Language ("Catal\u00e0",
		...
		new Language ("Deutsch",
			...
			MediaSize.ISO.A4),
		new Language ("Dansk",
			AD_Language_da_DK,  new Locale("da","DK"),  Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		...
		new Language ("Espa\u00f1ol",
			AD_Language_es_ES,  new Locale("es","ES"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
		new Language ("Espa\u00f1ol (MX)",
			AD_Language_es_MX,  new Locale("es","MX"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.NA.LETTER),
		new Language ("Farsi",
			AD_Language_fa_IR,  new Locale("fa","IR"),  Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		new Language ("Finnish",
			AD_Language_fi_FI,  new Locale("fi","FI"),  null, "dd.MM.yyyy",	//	space ,
			MediaSize.ISO.A4),
		...
		new Language ("Bahasa Indonesia",
			AD_Language_in_ID, new Locale("in","ID"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		...
		new Language ("Lithuanian",
			AD_Language_lt_LT, new Locale("lt","LT"), null, null,
			MediaSize.ISO.A4),
		new Language ("Malay",
			AD_Language_ml_ML, new Locale("ml","ML"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		new Language ("Nederlands",
			AD_Language_nl_NL, new Locale("nl","NL"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		new Language ("Norsk",
			AD_Language_no_NO,  new Locale("no","NO"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
		new Language ("Polski",
			AD_Language_pl_PL, new Locale("pl","PL"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		new Language ("Portuguese (BR)",
			AD_Language_pt_BR, new Locale("pt","BR"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
		new Language ("Rom\u00e2n\u0103",
			AD_Language_ro_RO, new Locale("ro","RO"), Boolean.valueOf(false), "dd.MM.yyyy",
			MediaSize.ISO.A4),
		new Language ("\u0420\u0443\u0441\u0441\u043a\u0438\u0439 (Russian)",
			AD_Language_ru_RU, new Locale("ru","RU"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
		new Language ("Slovenski",
			AD_Language_sl_SI, new Locale("sl", "SI"), null, "dd.MM.yyyy",
			MediaSize.ISO.A4),
		new Language ("Svenska",
			AD_Language_sv_SE,  new Locale("sv","SE"),  Boolean.valueOf(false), "dd.MM.yyyy",
			MediaSize.ISO.A4),
		new Language ("\u0e44\u0e17\u0e22 (TH)",
			AD_Language_th_TH,  new Locale("th","TH"), Boolean.valueOf(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
		new Language ("Vi\u1EC7t Nam",
			AD_Language_vi_VN, new Locale("vi","VN"), Boolean.valueOf(false), "dd-MM-yyyy",
			MediaSize.ISO.A4),
	...
	public static Language getLanguage (String langInfo)
	{
		...
		for (Language element : s_languages) {
			if 	(lang.equals(element.getName())
				||  lang.equals(element.getLanguageCode())
				|| lang.equals(element.getAD_Language()))
				return element;
		}
	...
	public static String getAD_Language (Locale locale)
	{
		...
		{
			for (Language element : s_languages) {
				if 	(locale.equals(element.getLocale()))
					return element.getAD_Language();
			}
		}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Decimal=" + sym.getDecimalSeparator() + "(" + (int)sym.getDecimalSeparator()
			+ ") - Group=" + sym.getGroupingSeparator() + "(" + (int)sym.getGroupingSeparator()
			+ ") - Minus=" + sym.getMinusSign() + "(" + (int)sym.getMinusSign() + ")");

		System.out.println(format.format(12345.78));
	}
